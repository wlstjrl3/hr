...
<div class="container"
    style="background:#555; padding: 50px 0; display:flex; flex-direction:column; align-items:center;">

    <div
        style="background:#fff; padding:20px; margin-bottom:20px; border-radius:8px; width:800px; box-shadow:0 10px 30px rgba(0,0,0,0.3);">
    ...
    <div id="printArea" class="print-container">
        <div class="cert-paper <?php echo $typeClass; ?>">
            ...
            <img src="<?php echo DIR_ROOT; ?>/assets/img/certs/cert_bg_cross.png" class="cert-logo-cross"
                style="opacity: <?php echo ($certType == '퇴직') ? '0.9' : ($certType == '경력' ? '0.05' : '0.12'); ?>;"
            ...
            <?php if ($certType == '경력'): ?>
                ...
                <div class="cert-inner layout-career">
                    ...
                    <div class="p_TITLE_wrap_career"
                        ...
                        <span
                            style="font-family:'CasuwonBold', 'Malgun Gothic', '맑은 고딕', sans-serif; font-size:35pt; font-weight:900; letter-spacing:15px; padding-left:15px;">
                            경 력 증 명 서
                        </span>
                    </div>
                        ...
                        <table class="career-table"
                            ...
                            <tr>
                                <td class="lblBg"
                                    ...
                                    성 명</td>
                                <td style="width:35%; border:1px solid #777; font-family:'NanumMyeongjo', serif; font-size:17pt;"><?php 
                                    $len = mb_strlen($nm, 'UTF-8');
                                    $sp = ($len == 2) ? '32pt' : (($len == 3) ? '13pt' : (($len == 4) ? '6pt' : '0'));
                                    echo '<span style="letter-spacing:'.$sp.'; margin-right:-'.$sp.'">'.$nm.'</span>';
                                ?></td>
                                <td class="lblBg"
                                    style="width:20%; font-weight:bold; letter-spacing:5px; border:1px solid #777;">생 년 월 일
                                </td>
                            ...
                            <tr style="height:25mm;">
                                <td style="border:1px solid #777; font-family:sans-serif;">
                                    <?php echo str_replace(['년 ', '월 ', '일'], ['.', '.', '.'], $joinDt); ?></td>
                                <td style="border:1px solid #777; font-family:sans-serif;">
                                    <?php echo str_replace(['년 ', '월 ', '일'], ['.', '.', '.'], date("Y년 n월 j일", strtotime("-1 day"))); ?>
                                </td>
                    ...
                    <div class="p_SECTION_FOOTER_C"
                        ...
                        <div class="p_ISSUER_wrap" style="position:relative; display:inline-block;">
                            <span class="issuer-name"
                                ...
                                수원교구 제1대리구장</span>
                            <img src="<?php echo DIR_ROOT; ?>/assets/img/certs/official_seal.png" class="official-seal"
                                onerror="this.style.display='none'">
                        </div>
                    </div>
                </div>
                ...
                <div class="cert-inner layout-standard">
                    ...
                    <div class="p_SECTION_MID">
                        <div class="cert-row-mid">
                            ...
                            <div class="val" id="p_PSNL_NM_PREVIEW">
                            <?php 
                                $len = mb_strlen($nm, 'UTF-8');
                                $spacing = '0';
                                if($len == 2) $spacing = '32pt';
                                else if($len == 3) $spacing = '13pt';
                                else if($len == 4) $spacing = '6pt';
                                echo '<span style="letter-spacing:'.$spacing.'; margin-right:-'.$spacing.'; font-family:\'NanumMyeongjo\', serif;">'.$nm.'</span>';
                            ?>
                        </div>
                        </div>
                        <div class="cert-row-mid">
                            <div class="lbl">생년월일</div>
                            <div class="val" style="font-family:'NanumMyeongjo', serif;">
                                <?php echo str_replace(['년 ', '월 ', '일'], ['.', '.', '.'], $birth); ?></div>
                        </div>
                    </div>
...
<style>
    ...
    .cert-paper {
        ...
        font-family: 'CasuwonBold', 'Nanum Myeongjo', 'Batang', serif;
        color: #000;
    ...
    /* [퇴직증명서 전용 스타일] */
    .type-retire .p_TITLE_wrap span {
        font-family: 'CasuwonBold', 'Malgun Gothic', '맑은 고딕', sans-serif;
        font-weight: 900;
        font-size: 38pt;
        letter-spacing: 30px;
        padding-left: 30px;
    ...
    .type-retire .p_SECTION_TOP {
        top: 95mm;
    }

    .type-retire .p_SECTION_MID {
        left: 0;
        align-items: center;
        top: 135mm;
    }

    .type-retire .p_SECTION_MID .cert-row-mid {
        width: 100mm;
        margin-left: 50mm;
    }

    .type-retire .p_SECTION_BODY {
        top: 175mm;
        font-size: 18pt;
    }

    .type-retire .p_SECTION_FOOTER {
        top: 220mm;
    }

    .type-retire .issuer-name {
        font-family: 'CasuwonBold', 'Malgun Gothic', '맑은 고딕', sans-serif;
        font-size: 30pt;
        letter-spacing: 4px;
    }
