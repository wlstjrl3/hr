...
function trDataXHR(idx) {
    const url = DIR_ROOT + "/sys/userConfig.php?key=" + API_TOKEN + "&USER_CD=" + idx + "&CRUD=R";
    console.log(url);
    fetch(url)
        .then(response => {
...
modalEdtBtn.addEventListener("click", () => {
    ...
    const url = DIR_ROOT + "/sys/userConfig.php?key=" + API_TOKEN + writeUrl + "&CRUD=C";
    console.log(url);
...
modalDelBtn.addEventListener("click", () => {
    ...
    const url = DIR_ROOT + "/sys/userConfig.php?key=" + API_TOKEN + deleteUrl + "&CRUD=D";
    console.log(url);
