...
<div class="modalForm">
    ...
    <div class="modalWindow">
        ...
        <div class="modalBody">
            ...
            <div class="modalGrp">
                <div class="modalHd">자격번호</div>
                <div class="modalBd"><input autocomplete='off'></div>
            </div>
            <div class="modalGrp">
                <div class="modalHd">자격명칭</div>
                <div class="modalBd"><input autocomplete='off'></div>
            </div>
            <div class="modalGrp">
                <div class="modalHd">자격등급</div>
                <div class="modalBd"><input autocomplete='off'></div>
            </div>
            <div class="modalGrp">
                <div class="modalHd">자격취득일</div>
...
<div class="container">
    ...
    <div class="searchArea">
        ...
        <div class="colGrp">
            <div class="colHd clBg5 cl2"><span><b>자격번호</b></span></div>
            <div class="colBd"><input id="LCS_NUM" class="filter"></div>
        </div>
        <div class="colGrp">
            <div class="colHd2L clBg5 cl2"><span><b>자격/면허<br>명칭</b></span></div>
            <div class="colBd"><input id="LCS_NM" class="filter"></div>
        </div>
        <div class="colGrp">
            <div class="colHd clBg5 cl2"><span><b>자격등급</b></span></div>
            <div class="colBd"><input id="LCS_LEVEL" class="filter"></div>
        </div>
        <div class="colGrp">
            <div class="colHd clBg5 cl2"><span><b>자격취득일</b></span></div>
            <div class="colBd"><input class="dualDateBox dateBox filter" id="LCS_GET_DT_From"><span>~</span><input class="dualDateBox dateBox filter" id="LCS_GET_DT_To"></div>
        </div> 
        <div class="colGrp">
            <div class="colHd clBg5 cl2"><span><b>상세정보</b></span></div>
            <div class="colBd"><input id="LCS_DTL" class="filter"></div>
        </div>       
        <div class="colGrp">
            <div class="colHd2L clBg5 cl2"><span><b>자격수당<br>금액범위</b></span></div>
            <div class="colBd"><input class="dualDateBox filter" id="LCS_PAY_From"><span>~</span><input class="dualDateBox filter" id="LCS_PAY_To"></div>
        </div>
        <div class="colGrp">
            <div class="colHd2L clBg5 cl2"><span><b>수당지급<br>시작일</b></span></div>
            <div class="colBd"><input class="dualDateBox dateBox filter" id="LCS_STT_DT_From"><span>~</span><input class="dualDateBox dateBox filter" id="LCS_STT_DT_To"></div>
        </div>
        <div class="colGrp">
            <div class="colHd2L clBg5 cl2"><span><b>수당지급<br>종료일</b></span></div>
            <div class="colBd"><input class="dualDateBox dateBox filter" id="LCS_END_DT_From"><span>~</span><input class="dualDateBox dateBox filter" id="LCS_END_DT_To"></div>
        </div>    
...
<script type='text/javascript' src='/assets/js/lcsList.js'></script>
