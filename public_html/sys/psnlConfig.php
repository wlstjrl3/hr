<?php
    ...
    if($_REQUEST['CRUD']=='C'){
        ...
        if($_REQUEST['PSNL_CD']==""){ //신규 작성
            $sql = "INSERT INTO BONDANG_HR.PSNL_INFO(ORG_CD, PSNL_NM, BAPT_NM,PHONE_NUM,PSNL_NUM, REG_DT, REG_PER) VALUES ('";
            $sql = $sql.$_REQUEST['ORG_CD']."','".$_REQUEST['PSNL_NM']."','".$_REQUEST['BAPT_NM'];
