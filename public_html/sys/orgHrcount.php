...
$sql = "SELECT B.ORG_NM AS UPR_ORG_NM
        ...
        LEFT OUTER JOIN (
            SELECT 
                ...
                SUM(CASE WHEN SUBSTR(REPLACE(P.PSNL_NUM, '-', ''), 7, 1) IN ('1', '3', '5', '7', '9') THEN 1 ELSE 0 END) AS MALE_CNT,
                SUM(CASE WHEN SUBSTR(REPLACE(P.PSNL_NUM, '-', ''), 7, 1) IN ('2', '4', '6', '8', '0') THEN 1 ELSE 0 END) AS FEMALE_CNT,
