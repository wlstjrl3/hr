...
verifyApiKey($conn, @$_REQUEST['key']);
    ...
    LEFT OUTER JOIN PSNL_TRANSFER D ON D.TRS_CD = (SELECT MAX(TRS_CD) TRS_CD FROM PSNL_TRANSFER WHERE PSNL_CD=A.PSNL_CD AND TRS_TYPE IN (1,3) AND TRS_DT <= A.ADVANCE_DT)
