...
$result = mysqli_query($conn, "SELECT * FROM USER_TB WHERE USER_ID='" . $_POST['admin-id'] . "'");
$row = mysqli_fetch_array($result);
mysqli_close($conn);
if (@$row['USER_ID'] == '' || $row['USER_PASS'] != md5($_POST['admin-password'])) { //.@$row['USER_ID'].@$row['USER_PASS'].$_POST['admin-password'].
    echo "<script> 
